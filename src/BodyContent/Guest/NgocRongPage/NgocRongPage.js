...
const NgocRongPage = () => {
    ...
    const [filterHanhTinh, setFilterHanhTinh] = useState('Tất cả Hành tinh');
    const [filterBongTai, setFilterBongTai] = useState('Không chọn');
    ...
    const applyFilters = (account) => {
        ...
        if (filterHanhTinh != 'Tất cả Hành tinh' && account.hanh_tinh !== filterHanhTinh) {
            return false;
        }
        if (filterBongTai !== 'Không chọn' && account.bong_tai !== filterBongTai) {
            return false;
        }
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <Box className="filter-container">
                        ...
                        <FormControl variant="outlined" className="filter-control">
                            <InputLabel>Hành tinh</InputLabel>
                            <Select value={filterHanhTinh} onChange={(e) => setFilterHanhTinh(e.target.value)}>
                                <MenuItem value="Tất cả Hành tinh">Tất cả Hành tinh</MenuItem>
                        ...
                        <FormControl variant="outlined" className="filter-control">
                            <InputLabel>Bông Tai</InputLabel>
                            <Select value={filterBongTai} onChange={(e) => setFilterBongTai(e.target.value)}>
